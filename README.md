...
This project studies coherence from _Unsupervised Elicitation of Language Models_, which introduces Internal Coherence Maximization (ICM).
...
## Hyperbolic Credential Check

1. Create your local env file:
   - `cp .env.example .env`
2. Edit `.env` and set:
   - `HYPERBOLIC_API_KEY`
3. Verify API + model access:
